          ...
          if (response.credential) {
            ...
            try {
              ...
              if (data?.data?.token) {
                ...
                setMessage(
                  data.message || "Error desconocido en registro con Google."
                );
    ...
    try {
      ...
      if (data?.data?.token) {
        ...
        if (
          ...
          setMessage(
            "No se pudo completar el registro. Por favor, verifica tus datos o intenta con otro correo."
          );
        } else {
          setMessage(
      ...
      <form className="login-form" onSubmit={handleSubmit}>
        ...
        <label
          style={{
            ...
            fontSize: "0.98rem",
            gap: "0.5rem",
            color: "var(--color-texto-adicional)",
          }}
        >
          <input
            type="checkbox"
